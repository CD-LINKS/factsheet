...
if(cfg$r=="JPN"){
  ...
  indc_cats <- c("NoPOL","NPi","INDC","2030_low","2030_high","2020_verylow")
}
  nat_cats <- intersect(unique(all[Scope=="national"]$Category),indc_cats)

plot_line(reg=cfg$r,dt=all,vars=c("GDP|MER","Population"),cats=c("INDC"),title="Socio-Economic Indicators",file_pre="gdp_pop_line")   
...
cats <- nat_cats #intersect(nat_cats,c("INDC","2020_low","2030_low"))
...
```{r, echo=FALSE,results = 'hide',cache=FALSE, message=FALSE, warning=FALSE,fig.width=8, fig.height=10, dpi=200}
if (!identical(character(0),intersect(nat_cats,c("NoPOL","2020_low","2030_low","2030_high","INDC")) )){
# Please specify exactly two variables and assign them to x and y
vars <- c(x="GDP|MER",y="Final Energy")
cats <- intersect(nat_cats,c("NoPOL","2020_low","2030_low","2030_high","INDC"))
