...
write.table(filter(PRIMAP_selec_Gases_output, variable!="Emissions|Kyoto Gases"), file="data/History_fig2.csv", sep=";", row.names = FALSE)
write.table(PRIMAP_selec_Gases_output, file="data/History_fig3.csv", sep=";", row.names = FALSE)
...
GHG_intensity_rate_annual_hist <- group_by(GHG_intensity_hist, variable, scenario, region, unit, source) %>% mutate(prev=lag(value)) %>% 
                                  mutate(value=value/prev-1) %>%
...
write.table(GHG_intensity_rate_annual_hist, file="data/History_GHG_Intensity_1yrperiod.csv", sep=";", row.names = FALSE)
...
write.table(GHG_intensity_rate_annual5yrperiod_hist, file="data/History_GHG_Intensity_5yrperiod.csv", sep=";", row.names = FALSE)
...
write.table(d_cd_links_GHG_countries_stat_fig2 , file="data/figure2.csv", sep=";", row.names = FALSE)
