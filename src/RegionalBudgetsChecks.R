...
scens2deg <- c("NoPolicy_V4","NoPOL_V4","NPi_V4","INDCi_V4", "NPi2020_1600_V4","NPi2020_1000_V4", "NPi2020_400_V4")
...
for (reg in map_pri$dat){
    ...
    p = p + geom_path(data=v_plot[scenario %in% c("INDCi_V4","INDC_V4") & region == reg & variable == as.character(vars$long[var]) & period < 2031,],
