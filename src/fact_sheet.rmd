...
plot_funnel(reg=cfg$r,dt=all,vars=vars,cats=cats,title="Key energy system characteristics",file_pre="fe_pe_co2_funnel",glob_lines=T)   
...
plot_funnel(reg=cfg$r,dt=all,vars=vars,cats=cats,title="Kaya factors",file_pre="kaya_funnel",glob_lines=T)   
...
cats <- c("Baseline","Optimal 450")
plot_scatter(reg=cfg$r,dt=all,vars_to_spread=vars,cats=cats,title="Relative Abatement",file_pre="relAb_co2pr_scatter",xlog=T,xlim=c(10,1000))   
...
# For ternary plots, 
vars <- c("Primary Energy|Coal","Primary Energy|Gas","Primary Energy|Oil","Primary Energy|Biomass","Primary Energy|Nuclear","Primary Energy|Non-Biomass Renewables")
cats <- c("Baseline","Optimal 450")
