...
#Carbon budget
regs <- c("BRA","CHN","IND", "RUS", "EU","JPN","USA")
plot_boxplot(regs=regs,dt=all,vars="Carbon budget",cats="INDC2030i_1000",year=2100,file_pre="CO2budget_2011-2100_INDC2030i_1000")
plot_boxplot(regs=regs,dt=all,vars="Carbon budget",cats="INDC2030i_1600",year=2100,file_pre="CO2budget_2011-2100_INDC2030i_1600")
plot_boxplot(regs=regs,dt=all,vars="Carbon budget",cats="NPi2020_1000",year=2100,file_pre="CO2budget_2011-2100_NPi2020_1000")
plot_boxplot(regs=regs,dt=all,vars="Carbon budget",cats="NPi2020_1600",year=2100,file_pre="CO2budget_2011-2100_NPi2020_1600")
...
plot_boxplot3(regs="JPN",dt=all,vars=c("Primary Energy","Energy Intensity of GDP|MER","Wind and Solar Share","Renewables Share|Incl. Hydro and Nuclear","Secondary Energy|Electricity"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
plot_boxplot3(regs="IND",dt=all,vars=c("Primary Energy","Energy Intensity of GDP|MER","Wind and Solar Share","Renewables Share|Incl. Hydro and Nuclear","Secondary Energy|Electricity"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
plot_boxplot3(regs="CHN",dt=all,vars=c("Primary Energy","Energy Intensity of GDP|MER","Wind and Solar Share","Renewables Share|Incl. Hydro and Nuclear","Secondary Energy|Electricity"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
plot_boxplot3(regs="RUS",dt=all,vars=c("Primary Energy","Energy Intensity of GDP|MER","Wind and Solar Share","Renewables Share|Incl. Hydro and Nuclear","Secondary Energy|Electricity"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
plot_boxplot3(regs="EU",dt=all,vars=c("Primary Energy","Energy Intensity of GDP|MER","Wind and Solar Share","Renewables Share|Incl. Hydro and Nuclear","Secondary Energy|Electricity"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
plot_boxplot3(regs="World",dt=all,vars=c("Emissions|CO2|Energy|Demand|Transportation","Emissions|CO2|Energy|Demand|Industry","Emissions|CO2|Energy|Demand|Residential and Commercial","Emissions|CO2|Energy|Supply","Emissions|CO2|AFOLU"),
              cats=c("Historical","NoPolicy","NPi","INDCi"),year=2030,b.multivar=T,var.labels=c("Transportation","Industry","Residential and Commercial","Energy Supply","AFOLU"),file_pre="Sector_Emis_CO2_2030_World",ylim=T)
plot_boxplot3(regs="World",dt=all,vars=c("Emissions|CO2|Energy|Demand|Transportation","Emissions|CO2|Energy|Demand|Industry","Emissions|CO2|Energy|Demand|Residential and Commercial","Emissions|CO2|Energy|Supply","Emissions|CO2|AFOLU"),
              cats=c("Historical","NoPolicy","NPi","INDCi"),year=2020,b.multivar=T,var.labels=c("Transportation","Industry","Residential and Commercial","Energy Supply","AFOLU"),file_pre="Sector_Emis_CO2_2020_World",ylim=T)

###Sectoral energy
#Energy supply
plot_boxplot3(regs="World",dt=all,vars=c("Primary Energy","Energy Intensity of GDP|MER","Wind and Solar Share","Renewables Share|Incl. Hydro and Nuclear","Secondary Energy|Electricity"),cats=c("NoPolicy","NPi","INDCi"),
...
#Electricity only
plot_boxplot3(regs="World",dt=all,vars=c("Secondary Energy|Electricity","Wind and Solar Share","Renewables Share|Incl. Hydro and Nuclear","Low-carbon Electricity Share|All excl. Fossil w/o CCS"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
#AFOLU
plot_boxplot3(regs="World",dt=all,vars=c("Land Cover","Land Cover|Cropland","Land Cover|Cropland|Energy Crops","Primary Energy|Biomass|Traditional"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
#FE all sectors
plot_boxplot3(regs="World",dt=all,vars=c("Final Energy|Transportation","Final Energy|Industry","Final Energy|Residential and Commercial"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
plot_boxplot3(regs="World",dt=all,vars=c("Final Energy|Solids|Biomass","Final Energy|Transportation|Liquids|Biomass"),cats=c("Historical","NoPolicy","NPi","INDCi"),
...
#Buildings
plot_boxplot3(regs="World",dt=all,vars=c("Final Energy|Residential and Commercial|Electricity","Final Energy|Residential and Commercial|Gases","Final Energy|Residential and Commercial|Hydrogen","Final Energy|Residential and Commercial|Liquids","Final Energy|Residential and Commercial|Other","Final Energy|Residential and Commercial|Heat","Final Energy|Residential and Commercial|Solids"),cats=c("Historical","NoPolicy","NPi","INDCi"),
