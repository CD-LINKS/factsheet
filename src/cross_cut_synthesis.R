...
catsnat <- c("NPi", "2020_low",  "2030_low","2020_verylow")
catglob <- "2020_low"
...
catsnat <- c("2020_verylow")
catglob <- "2020_verylow"
plot_pointrange_multiScen_yr(regs=regs,dt=all,vars=c("Carbon budget|Energy and Industry"),catglob = catglob, catsnat = catsnat,
                             years=c(2050),file_pre="Cbudget_2011-2050_2020_verylow", var.labels = c("Carbon budget [GtCO2] - 2020_verylow - 2050"),b.multiyear = F)