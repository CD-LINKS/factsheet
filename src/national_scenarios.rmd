...
#all scenarios with national model scenarios available
  ...
  nat_scens <- intersect(c("NoPOL_V2","NPi_V2","INDC_V2","NPi2020_high_V2","NPi2020_low_V2","INDC2030_high_V2","INDC2030_low_V2","NPi2020_verylow_V2"),unique(all[Scope=="national"]$scenario))
