...
#all scenarios with national model scenarios available
  ...
  nat_scens <- intersect(c("NoPOL_V3","NPi_V3","INDC_V3","NPi2020_high_V3","NPi2020_low_V3","INDC2030_high_V3","INDC2030_low_V3","NPi2020_verylow_V3"),unique(all[Scope=="national"]$scenario))
