...
cats <- unique(all$Category) #intersect(nat_cats,c("INDC","2020_low","2030_low"))

plot_bar_facet(reg=cfg$r,dt=all,vars=vars,cats=cats,lab="Rate of change (%/year; 2030-2050)",file_pre="rate_of_change_bar")   
#}
invisible(dev.off())
