...
plot_line(reg=cfg$r,dt=all,vars=c("Policy Cost|Consumption Loss","Policy Cost|GDP Loss"),cats=c("2020_low"),title="Policy Costs in 2020_low scenarios",file_pre="cons_gdp_loss_line")   
...
cats <- c("NoPOL","2020_low","2030_high")
...
plot_funnel(reg=cfg$r,dt=all,vars=c("Emissions|Kyoto Gases"),cats=c("Baseline","2020_low","2030_high"),title="Kyoto gas emissions",file_pre="GHG_funnel",glob_lines=T,xlim=c(2000,2050))   
