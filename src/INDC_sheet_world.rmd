...
vars <- c("Primary Energy","Secondary Energy|Electricity","Energy Intensity of GDP|MER","Renewables Share|Incl. Hydro and Nuclear")
cats <- c("NPi","INDC","Reference")
...
plot_funnel(reg=cfg$r,dt=all,vars=c("Emissions|Kyoto Gases","Emissions|Kyoto Gases|Excl. AFOLU CO2","Emissions|CO2"),cats=cats,title="Kyoto gas emissions including/excluding AFOLU CO2",file_pre="GHG_AFOLU_funnel",glob_lines=T,xlim=c(2000,2050))   
...
cats <- c("NPi","INDC","2020_low","2030_low","2030_high")
