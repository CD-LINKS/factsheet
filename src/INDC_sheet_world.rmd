...
cats <- c("2030_low","2030_low","2030_high","2030_high")
models <- intersect(unique(all[Category %in% c("2030_low")]$model),all[Category %in% c("2030_low")]$model)
...
vars <- c('Final Energy','Primary Energy','Emissions|CO2|FFI')#'Population')
cats <- c("2020_verylow","INDC2030i_400")
...
vars <- c('Final Energy','Primary Energy','Emissions|CO2|FFI')#'Population')
cats <- c("INDC","INDC","NPi","REF")
models <- intersect(unique(all[Category %in% c("INDC")]$model),all[Category %in% c("INDC")]$model)
...
cats <- c("Historical","NPi","INDC","REF","INDC")
...
cats <- c("2020_verylow","INDC2030i_400","2020_low")
...
vars <- c("GDP per capita|MER","Energy Intensity of GDP|MER","Carbon Intensity of FE","Emissions per capita")
cats <- c("NPi","INDC","2020_verylow","2020_low","2020_high","INDC2030i_400","2030_low","2030_high")
...
cats <- c("NPi","INDC","2020_verylow","2020_low","2020_high","INDC2030i_400","2030_low","2030_high") #unique(all$Category) #intersect(nat_cats,c("INDC","2020_low","2030_low"))
...
cats <- c("NPi","INDC","2020_verylow","2020_low","2020_high","INDC2030i_400","2030_low","2030_high") #unique(all$Category)
