...
# if(cfg$r=="JPN"){
#   nat_cats <- intersect(unique(all[Scope=="national"]$Category),c("NoPolicy","NPi","INDCi","NPi2020_1000","INDC2030i_1600"))
# } else  {
#   nat_cats <- intersect(unique(all[Scope=="national"]$Category),c("NoPolicy","NPi","INDCi","INDC2030i_1000","INDC2030i_1600"))
# }

plot_line(reg=cfg$r,dt=all,vars=c("GDP|MER","Population"),cats=c("NoPolicy"),title="Socio-Economic Indicators",file_pre="gdp_pop_line")   
...
plot_line(reg=cfg$r,dt=all,vars=c("Policy Cost|Consumption Loss","Policy Cost|GDP Loss","Policy Cost|Area under MAC Curve"),cats=c("INDC2030i_1600"),title="Policy Costs in INDC2030i_1600 scenarios",file_pre="cons_gdp_loss_line")   

invisible(dev.off())

```

\subsection{Policy costs - comparison ADVANCE}

```{r, echo=FALSE,results = 'hide',cache=FALSE, message=FALSE, warning=FALSE,fig.width=8, fig.height=10, dpi=200}

vars <- c("Policy Cost|Consumption Loss","Policy Cost|GDP Loss","Policy Cost|Area under MAC Curve")
cats <- c("INDC2030i_1000","2030_low","INDC2030i_1600","2030_high")
models <- intersect(unique(all[Category %in% c("INDC2030i_1000")]$model),all[Category %in% c("2030_low")]$model)

plot_funnel(reg=cfg$r,dt=all[period<=2100 & model %in% models],vars=vars,cats=cats,title="Policy costs",file_pre="policy_costs_funnel_ADV",glob_lines=T,xlim=c(2000,2100))   
...
cats <- c("NoPolicy","NPi","INDCi","NPi2020_1000","NPi2020_1600","INDC2030i_1000","INDC2030i_1600")
...
vars <- c('Final Energy','Primary Energy','Emissions|CO2|FFI')#'Population')
cats <- c("NPi2020_1000","INDC2030i_1000")
...
vars <- c('Final Energy','Primary Energy','Emissions|CO2|FFI')#'Population')
cats <- c("NPi2020_400","INDC2030i_400")
...
\subsection{Key energy system characteristics - long-term - comparison ADVANCE}
...
plot_funnel(reg=cfg$r,dt=all[period<=2100 & model %in% models],vars=vars,cats=cats,title="Key energy system characteristics",file_pre="fe_pe_co2_funnel_LT_ADV",glob_lines=T,xlim=c(2000,2100))   
...
\subsection{Key energy system characteristics - long-term - comparison ADVANCE2}

```{r, echo=FALSE,results = 'hide',cache=FALSE, message=FALSE, warning=FALSE,fig.width=8, fig.height=10, dpi=200}

vars <- c('Final Energy','Primary Energy','Emissions|CO2|FFI')#'Population')
cats <- c("INDCi","INDC","NPi","REF")
models <- intersect(unique(all[Category %in% c("INDCi")]$model),all[Category %in% c("INDC")]$model)

plot_funnel(reg=cfg$r,dt=all[period<=2100 & model %in% models],vars=vars,cats=cats,title="Key energy system characteristics",file_pre="fe_pe_co2_funnel_LT_ADV2",glob_lines=T,xlim=c(2000,2100))   
...
cats <- c("Historical","NPi","INDCi","REF","INDC")
...
cats <- c("NoPolicy","NPi","INDCi","NPi2020_1000","NPi2020_1600","INDC2030i_1000","INDC2030i_1600","NPi2020_400")
...
\subsection{Kyoto gas emissions over time - comparison ADVANCE}
...
cats <- c("NPi2020_400","INDC2030i_400","NPi2020_1000")
...
\subsection{Kyoto gas emissions over time - detailed - long-term - comparison ADVANCE}
...
plot_funnel2(reg=cfg$r,dt=all[model %in% models],vars=c("Emissions|Kyoto Gases","Emissions|CO2|AFOLU"),cats=cats,title="Kyoto gas emissions including/only AFOLU CO2",file_pre="GHG_AFOLU_funnel_LT_ADV2",glob_lines=T,xlim=c(2000,2100))   
...
```{r, echo=FALSE,results = 'hide',cache=FALSE, message=FALSE, warning=FALSE,fig.width=8, fig.height=10, dpi=200}
#if (!identical(character(0),intersect(nat_cats,c("NoPolicy","NPi2020_1000","INDC2030i_1000")) )){
...
#if (!identical(character(0),intersect(nat_cats,c("NoPolicy","NPi2020_1000","INDC2030i_1000")) )){
vars <- c("GDP per capita|MER","Energy Intensity of GDP|MER","Carbon Intensity of FE","Emissions per capita")
cats <- c("NPi2020_1000","NPi2020_1600","INDC2030i_1000","INDC2030i_1600")
...
vars <- c("GDP per capita|MER","Energy Intensity of GDP|MER","Carbon Intensity of FE","Emissions per capita")
cats <- c("NPi","INDCi","NPi2020_400","NPi2020_1000","NPi2020_1600","INDC2030i_400","INDC2030i_1000","INDC2030i_1600")
...
```{r, echo=FALSE,results = 'hide',cache=FALSE, message=FALSE, warning=FALSE,fig.width=8, fig.height=10, dpi=200}
#if (!identical(character(0),intersect(nat_cats,c("INDCi","NPi2020_1000","INDC2030i_1000")) )){
...
cats <- c("NPi","INDCi","NPi2020_400","NPi2020_1000","NPi2020_1600","INDC2030i_400","INDC2030i_1000","INDC2030i_1600") #unique(all$Category) #intersect(nat_cats,c("INDCi","NPi2020_1000","INDC2030i_1000"))
...
cats <- c("NPi","INDCi","NPi2020_400","NPi2020_1000","NPi2020_1600","INDC2030i_400","INDC2030i_1000","INDC2030i_1600") #unique(all$Category)
...
```{r, echo=FALSE,results = 'hide',cache=FALSE, message=FALSE, warning=FALSE,fig.width=8, fig.height=10, dpi=200}
#if (!identical(character(0),intersect(nat_cats,c("NPi2020_1000","INDC2030i_1000")) )){
  # Please specify exactly two variables and assign them to x and y
  vars <- c(x="Price|Carbon",y="relative Abatement|CO2")
  cats <- c("NPi2020_1000","INDC2030i_1000","INDC2030i_1600")
...
cats <- c("NPi2020_1000","INDC2030i_1000") #intersect(nat_cats,c("NPi2020_1000","INDC2030i_1000"))
...
cats <- c("NPi","INDCi","NPi2020_1000","NPi2020_1600","INDC2030i_1000","INDC2030i_1600")
