...
plot_funnel2(reg=cfg$r,dt=all[model %in% models],vars=c("Emissions|Kyoto Gases","Emissions|Kyoto Gases|Excl. AFOLU CO2","Emissions|CO2|AFOLU"),cats=cats,title="Kyoto gas emissions including/excluding AFOLU CO2",file_pre="GHG_AFOLU_funnel_LT_ADV",glob_lines=T,xlim=c(2000,2100))   
