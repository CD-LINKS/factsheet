...
\subsection{Key energy system characteristics - long-term}
...
plot_funnel(reg=cfg$r,dt=all[period<=2100],vars=vars,cats=cats,title="Key energy system characteristics",file_pre="fe_pe_co2_funnel",glob_lines=T,xlim=c(2000,2100))   
...
cats <- c("NPi","INDCi","REF","INDC")

plot_bar_facet2(reg=cfg$r,dt=all[period==2030],vars=vars,cats=cats,lab="Energy system characteristics",file_pre="Energy_bar_facet")   
...
plot_funnel(reg=cfg$r,dt=all,vars=c("Emissions|Kyoto Gases"),cats=cats,title="Kyoto gas emissions",file_pre="GHG_funnel",glob_lines=T,xlim=c(2000,2100))   
...
plot_funnel2(reg=cfg$r,dt=all,vars=c("Emissions|Kyoto Gases","Emissions|Kyoto Gases|Excl. AFOLU CO2","Emissions|CO2|AFOLU"),cats=cats,title="Kyoto gas emissions including/excluding AFOLU CO2",file_pre="GHG_AFOLU_funnel",glob_lines=T,xlim=c(2000,2030))   
...
plot_funnel2(reg=cfg$r,dt=all,vars=c("Emissions|Kyoto Gases","Emissions|Kyoto Gases|Excl. AFOLU CO2","Emissions|CO2|AFOLU"),cats=cats,title="Kyoto gas emissions including/excluding AFOLU CO2",file_pre="GHG_AFOLU_funnel",glob_lines=T,xlim=c(2000,2100))   
...
cats <- c("NPi","INDCi","NPi2020_1000","INDC2030i_1000","INDC2030i_1600")
...
#plot all scenarios with national model scenarios available
cats <- c("NPi","INDCi","NPi2020_1000","NPi2020_1600","INDC2030i_1000","INDC2030i_1600")
plot_area(reg=cfg$r,dt=all,vars=vars,cats=cats,lab="Primary Energy (EJ/yr)",file_pre="pe_area",xlim=c(2000,2100))   
