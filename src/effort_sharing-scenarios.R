...
data=invisible(fread(paste0("data/","cdlinks_effort_sharing_compare_20190904-175934",".csv"),header=TRUE))
...
native=invisible(fread(paste0("data/","cdlinks_effort_sharing_native_20190904-180038",".csv"),header=TRUE))
