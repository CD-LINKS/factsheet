...
data=invisible(fread(paste0("data/","cdlinks_effort_sharing_compare_20190710-164948",".csv"),header=TRUE))
...
native=invisible(fread(paste0("data/","cdlinks_effort_sharing_native_20190710-165217",".csv"),header=TRUE))
