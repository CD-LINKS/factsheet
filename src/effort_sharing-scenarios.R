...
data=invisible(fread(paste0("data/","cdlinks_effort_sharing_compare_20190912-153949",".csv"),header=TRUE))
...
native=invisible(fread(paste0("data/","cdlinks_effort_sharing_native_20190912-154027",".csv"),header=TRUE))
