...
data=invisible(fread(paste0("data/","cdlinks_effort_sharing_compare_20190327-134354",".csv"),header=TRUE))
...
native=invisible(fread(paste0("data/","cdlinks_effort_sharing_native_20190327-134444",".csv"),header=TRUE))
